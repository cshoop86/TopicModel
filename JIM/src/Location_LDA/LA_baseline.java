...
/**
 * Same as ULA_LDA but use item location 
 * instead of user location
 * 
 * 
 * @author huzhiting
 *
...
public class LA_baseline{
  ...
  */
    ...
    public LA_baseline(int V, int K, int U, int M, double[] alpha, double[] alpha_2,
    					double[] beta, double[] gamma, int iterations,
    ...
    public pair sample(int i,int j)
    {
		...
		for(int st=0;st<2;st++)
			for(int z=0;z<K;z++)
			{
				...
				probability[st][z] = first_term * second_term * third_term;
				
				if(probability[st][z] < 0){
					System.out.println(probability[st][z]+" "+first_term+" "+second_term+" "+third_term);
					System.out.println(locTopicCount[loc][z]+" "
										+locTopicCountSum[loc]+" "+userTopicCount[i][z]+" "
										+userTopicCountSum[i]);
				}
			}
		...
		if(p.a < 0 || p.b < 0)
		{
			System.out.println("sampling error " + p.a + " " + p.b);
			System.out.println("t "+ t +" "+probability[1][K-1]);
		}
    ...
    public pair sample2(int i,int j)
    {
		...
		for(int st=0;st<2;st++)
			for(int z=0;z<K;z++)
			{
				...
				probability[st][z]=first_term*third_term;
			}
